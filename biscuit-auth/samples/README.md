...
revocation ids:
- `2053dae7f39653281a4ce604cd967af23511bad8b8873c07b03d377171426b553eaea8858995345ffda638a4fdd231cf5de912085dc28a39c8eaeb35d729430b`
...
result: `Err(FailedLogic(Unauthorized { policy: Allow(0), checks: [Block(FailedBlockCheck { block_id: 0, check_id: 10, rule: "check if [true, false].type() == \"set\"" }), Block(FailedBlockCheck { block_id: 0, check_id: 11, rule: "check if set($t), $t.type() == \"set\"" })] }))`
