...
fn append_block_2(b: &mut Bencher) {
  ...
  let token2 = token.append_with_rng(&mut rng, &keypair2, block_builder).unwrap();
...
fn append_block_5(b: &mut Bencher) {
  ...
  b.iter(|| {
    ...
    let token3 = token2.append_with_rng(&mut rng, &keypair3, b).unwrap();
    ...
    let token4 = token3.append_with_rng(&mut rng, &keypair4, b).unwrap();
    ...
    let token5 = token4.append_with_rng(&mut rng, &keypair5, b).unwrap();
...
fn verify_block_5(b: &mut Bencher) {
  ...
  let data = {
    ...
    let token3 = token2.append_with_rng(&mut rng, &keypair3, block_builder).unwrap();

    let mut block_builder = token3.create_block();
    block_builder.check_resource("file1");
    block_builder.check_operation("read");

    let token4 = token3.append_with_rng(&mut rng, &keypair4, block_builder).unwrap();

    let mut block_builder = token4.create_block();
    block_builder.check_resource("file1");
    block_builder.check_operation("read");

    let token5 = token4.append_with_rng(&mut rng, &keypair5, block_builder).unwrap();
